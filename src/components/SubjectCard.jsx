...
const ProgressBar = ({ label, percentage, color }) => {
  return (
    <div className="mb-4">
      ...
      <div className="w-full bevel-3d h-4 bg-gray-100 overflow-hidden">
        <div
...
const SubjectCard = ({ subject }) => {
  ...
  return (
    <div className="bevel-3d-deep bg-white/80 backdrop-blur-sm p-0 overflow-hidden group hover:-translate-y-1 transition-all duration-300">
      {/* Header de Carte 3D avec Bande de Couleur */}
      <div className={`${getHeaderStyle()} p-4 flex items-center gap-3 border-t-0 border-x-0`}>
      ...
      <div className="px-6 pb-4 flex justify-between items-center">
        ...
        <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest group-hover:text-gray-600 transition-colors">
          Quête en cours...
        </span>
      </div>
    </div>
